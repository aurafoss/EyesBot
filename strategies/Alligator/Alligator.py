...
for pair in pair_to_check:
    ...
    if row['ema1'] > row['ema2'] and row['ema2'] > row['ema3'] and row['ema3'] > row['ema4'] and row['ema4'] > row['ema5'] and row['stoch_rsi'] < 0.8: #ligne choix achat
