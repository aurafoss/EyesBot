...
print("Ichimoku:Execution Time :", current_time)
...
for order in open_orders:
    ...
    if float(order["filledSize"]) > 0:
        print(
            f"Ichimoku:Order on {order['market']} is partially fill, create {order['side']} Market of {order['remainingSize']} {order['market']} order to complete it"
        )
